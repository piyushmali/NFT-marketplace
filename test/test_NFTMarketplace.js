...
describe("NFTMarketplace", function () {
    ...
    beforeEach(async function () {
        ...
        await myNFT.deployTransaction.wait(); // Wait for the deployment transaction to be mined

        NFTMarketplace = await ethers.getContractFactory("NFTMarketplace");
        nftMarketplace = await NFTMarketplace.deploy();
        await nftMarketplace.deployTransaction.wait(); // Wait for the deployment transaction to be mined
    });
